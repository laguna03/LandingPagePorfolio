...
const translations = {
    es: {
        ...
        'portfolio.title': 'Landing Pages 3D',
        'portfolio.title2': 'Inmersivas',
        'portfolio.subtitle': 'Landing pages 3D inmersivas diseñadas para sorprender y convertir más clientes.',
        ...
        'process.s3.desc': 'Diseñamos y programamos tu landing page desde cero en 5 a 7 días hábiles. Recibirás un preview para revisión antes del lanzamiento.',
        ...
        'process.s5.desc': 'Realizas el pago del segundo 50% ($250) y tu página sale en vivo. La mensualidad comienza después de este pago.',
    ...
    en: {
        ...
        'portfolio.title': '3D Landing Pages',
        'portfolio.title2': 'Immersive',
        'portfolio.subtitle': 'Immersive 3D landing pages designed to impress and convert more clients.',
        ...
        'process.s3.desc': 'We design and code your landing page from scratch in 5–7 business days. You will receive a preview to review before launch.',
        ...
        'process.s5.desc': 'You make the second 50% payment ($250) and your page goes live. Monthly maintenance starts after this payment.',
